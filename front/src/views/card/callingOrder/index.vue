        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="cardNumber">
                        <Input type="text" v-model="searchForm.cardNumber" placeholder="卡号码" clearable style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getCallingOrderList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
